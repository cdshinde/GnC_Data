...
# Performs the full analysis of both the test and trail datasets. 
...
# Run the analysis.
run.analysis("/home/chetanshinde/Documents/training/Data_Science/rcourse/UCI HAR Dataset")